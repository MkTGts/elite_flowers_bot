...
LEXCON_USER_HANDLERS: dict[str, str] = {
    ...
    "select_pay_order": "Заказ можно оплатить переводом по номеру <b>+7999-999-99-99 Ф. Имя Отчество</b>\nПосле оплаты, нажмите кнопку <b>Оплатил</b>, менджер проверит информаци и статус заказа либо иземниться, либо менеджер с вами свяжется.",
...
LEXICON_OPERATOR_KEYBOARDS: dict[str, str] = {
    ...
    "edit_order_status": "Изменить статус заказа",
